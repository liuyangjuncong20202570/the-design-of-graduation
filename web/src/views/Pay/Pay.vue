...
import { useCountDown } from '../../assets/js/useCountDown.js';
...
const getPayInfo = async () => {
  const res = await OrderStore.fetchOrder(route.query.id);
  if (res) {
    const { orderItem } = storeToRefs(OrderStore);
    payInfo.value = orderItem.value;
  }
